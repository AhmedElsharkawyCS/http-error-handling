...
declare class ExpressHttpError extends HttpAbstractError {
    next: NextFunction;
    initializer(req: Request, res: Response, next: NextFunction): void;
    ...
    customError(error: ErrorAttrs): void;
    handler(err: CustomError, req: Request, res: Response, next: NextFunction): void | Response<any, Record<string, any>>;
}
declare const HttpError: ExpressHttpError;
export { HttpError };
